...
def create_configuration_files
  ...
  template "#{new_resource.path}/shared/app.php" do
    source new_resource.database_template || "cakephp/app.php.erb"
...
#  set_production_in_core
  ...
  link "#{new_resource.release_path}/config/app.php" do
    to "#{new_resource.path}/shared/app.php"
  end
end
